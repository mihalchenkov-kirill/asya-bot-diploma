...
async def send_info(callback: types.CallbackQuery):
    # await callback.message.edit_text(text=show_info_text.mystery_1, reply_markup=YES_OR_NO)
    await callback.message.answer_photo(
        photo=mystery_pictures.mystery1,
        caption=show_info_text.mystery_1,
...
async def step_one(callback: types.CallbackQuery):
    ...
    await callback.message.answer_photo(
        photo=mystery_pictures.mystery2,
        caption=show_info_text.mystery_2,
        reply_markup=MYSTERY_YES
    )
...
async def step_two(callback: types.CallbackQuery):
    ...
    await callback.message.answer_photo(
        photo=mystery_pictures.mystery3,
        caption=show_info_text.mystery,
        reply_markup=MYSTERY_ANSWERS
    )
...
async def answer_instinct(callback: types.CallbackQuery):
    ...
    await callback.message.answer_photo(
        photo=mystery_pictures.mystery4,
        caption=show_info_text.mystery_3,
        reply_markup=MYSTERY_ANSWERS
    )
...
async def answer_wolf(callback: types.CallbackQuery):
    ...
    await callback.message.answer_photo(
        photo=mystery_pictures.mystery5,
        caption=show_info_text.mystery_4,
        reply_markup=MYSTERY_ANSWERS
    )
...
async def answer_sad(callback: types.CallbackQuery):
    ...
    await callback.message.answer_photo(
        photo=mystery_pictures.mystery6,
        caption=show_info_text.mystery_5,
        reply_markup=MYSTERY_ANSWERS
    )
...
async def answer_emotion(callback: types.CallbackQuery):
    ...
    await callback.message.answer_photo(
        photo=mystery_pictures.mystery7,
        caption=show_info_text.mystery_6,
        reply_markup=MYSTERY_ANSWERS
    )
...
async def answer_right(callback: types.CallbackQuery):
    ...
    await callback.message.answer_photo(
        photo=mystery_pictures.mystery8,
        caption=show_info_text.mystery_7,
        reply_markup=AFTER_MYSTERY_YES
    )
...
async def _(callback: types.CallbackQuery):
    ...
    # await callback.message.answer_photo(
    #     photo=mystery1,
    #     caption=show_info_text.mystery_15,
